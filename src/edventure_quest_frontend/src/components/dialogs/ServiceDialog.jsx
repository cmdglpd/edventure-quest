...
export default function ServiceDialog({ open, handleClose, name, edventurePoints, description, serviceImg }) {
    const loading = false
                ...
                <DialogContent sx={{ position: "relative" }}>
                    ...
                    <div className="flex gap-4">
                        <div className="w-[10rem]">
                            <img src={serviceImg} alt="cover image" style={{ width: "100%", height: "6rem", objectFit: "cover", objectPosition: "center", borderRadius: "10px", border: `4px solid ${colors.secondary}`, boxShadow: "0px 2px 4px rgba(0, 0, 0, 0.5)" }} />
                        </div>
