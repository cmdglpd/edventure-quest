...
export default function CompanionDialog({ open, handleClose, name, edventurePoints, description, companionImg, type, effect }) {
    const loading = false
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="w-full flex flex-col gap-2">
                            <div>
                                ...
                                <Typography variant="body2" sx={{ color: colors.tertiary, mt: "0.5rem" }}>GIFT: {effect}</Typography>
                            </div>
                        </div>
                    </div>
