...
export default function StoryQuestCard({ title, coverImg, type, synopsis }) {
    const navigate = useNavigate()

    const redirect = () => {
        return navigate("/quests/quest-details")
    }
    ...
    return <div className="card-theme-light flex flex-col gap-3 p-4">
        ...
        <Button onClick={redirect} variant="contained" color="brownLight" size="small" sx={{ flexGrow: 1, fontWeight: "bold", color: colors.tertiary }}>View Quests</Button>
    </div>
}